...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label = QLabel(self.groupBoxProjektname)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(0, 0, 1281, 91))
        font = QFont()
        font.setPointSize(48)
        self.label.setFont(font)
        self.label.setAlignment(Qt.AlignCenter)
        self.pushButton = QPushButton(self.groupBoxProjektname)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(1210, 30, 48, 48))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Hamburg RB0, Tag 1", None))
